...
function getUpgradeCost(item, currentLevel) {
  // Front-loaded: cheap first upgrade for instant gratification, expensive final tier
...
function renderShop(params = {}) {
  ...
  setTimeout(() => {
    div.querySelector('#btn-back-shop').addEventListener('click', () => showScreen('chapter-map'));
